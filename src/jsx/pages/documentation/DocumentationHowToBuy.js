...
import { SectionHero } from './Documentation';
                    ...
                    <div className="container-large">
                        <div className="padding-vertical padding-xxlarge">
                            <div className="content-grid">
                                <DocAside></DocAside>
                                <DocHowToContent></DocHowToContent>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        >
            ...
            <div className="text-rich-text w-richtext">
                ...
                <figure className="w-richtext-figure-type-image w-richtext-align-center">
                    <div>
                        <img
                            src="https://uploads-ssl.webflow.com/6191fe28d0a1c82aca7ea557/62c46c0bd92ccd4dec52a8d2_download-app.png"
                            loading="lazy"
                            alt
                        />
                    </div>
                ...
                >
                    <div>
                        <img
                            src="https://uploads-ssl.webflow.com/6191fe28d0a1c82aca7ea557/62c469cb98f5ff006e36641a_buy-daks-3.png"
                            loading="lazy"
                            alt
                        />
                    </div>
                ...
                >
                    <div>
                        <img
                            src="https://uploads-ssl.webflow.com/6191fe28d0a1c82aca7ea557/62c469f835bb23457a21eb34_buy-on-desktop.png"
                            loading="lazy"
                            alt
                        />
                    </div>
                ...
                <figure className="w-richtext-align-center w-richtext-figure-type-image">
                    <div>
                        <img
                            src="https://uploads-ssl.webflow.com/6191fe28d0a1c82aca7ea557/62c46e58d92ccddb7552ee5d_proceed.png"
                            loading="lazy"
                            alt
                        />
                    </div>
                ...
                >
                    <div>
                        <img
                            src="https://uploads-ssl.webflow.com/6191fe28d0a1c82aca7ea557/62c46b8d6bf44ccb60611cc4_sign-and-done.png"
                            loading="lazy"
                            alt
                        />
                    </div>
                ...
                <figure className="w-richtext-figure-type-image w-richtext-align-center">
                    <div>
                        <img
                            src="https://uploads-ssl.webflow.com/6191fe28d0a1c82aca7ea557/62c46bad5d9d37537f932951_bank-transfer.png"
                            loading="lazy"
                            alt
                        />
                    </div>
